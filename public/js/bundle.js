...
},{"./notificationComponent.react.js":1,"./tweetsComponent.react.js":4,"react":148}],3:[function(require,module,exports){
/** @jsx React.DOM */
...
module.exports = Tweet = React.createClass({displayName: 'Tweet',
  render: function(){
    ...
    return (
      React.DOM.div({className: "tweet" + (tweet.active ? ' active' : '')}, 
        React.DOM.img({src: tweet.avatar, className: "avatar"}), 
        React.DOM.div({className: "blockquote"}, 
          React.DOM.div({className: "cite"}, 
...
module.exports = Tweets = React.createClass({displayName: 'Tweets',
  ...
  render: function(){
    ...
    return (
      React.DOM.div({className: "tweets"}, content)
    )
...
},{"../Components/tweetApp.react":2,"react":148}]},{},[150]);
